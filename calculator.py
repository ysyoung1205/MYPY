...
def operator_click(operator):
    global new_calculation, operator_clicked
    global stored_value, current_operator, operator_is

    current = entry.get()
    current2 = entry2.get("1.0", "end").strip()
    print("1.new_cal: ",new_calculation)
    print("2.op_c: ",operator_clicked)
    print("3.s_value: ",stored_value)
    print("4.c_op: ",current_operator)
    print("5._is: ",operator_is)
...
def percent():
    ...
    global operator_is, stored_value
...
def pow():
    global current_operator, operator_is, new_calculation, operator_clicked, stored_value
    current = entry.get()  # 현재 입력 값
    ...
    if new_calculation:
        ...
        print("POW,new_calculation:", last_value)
    ...
    operator_is = True
    print("ENDPOWP_newcal", new_calculation)
    print("ENDPOWP_stored_value", stored_value)

   


def clear():
    global new_calculation,operator_is,operator_clicked,current_operator,stored_value
    entry.delete(0, tk.END)
    entry2.delete("1.0","end")
    new_calculation = False
    operator_is = False
...
def calculate(event=None):
    global new_calculation, operator_is
    current = entry.get()
    current2 = entry2.get("1.0","end").strip()
    print(operator_is)
